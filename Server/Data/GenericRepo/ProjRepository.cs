...
{
    public class ProjRepository : IRepository<Project>
    {
        public string connection { get; set; }

        public ProjRepository(IConfiguration configuration)
        {
        ...
        public async Task<DapperQueryDTO<Project>> Get(PaginationParams pagination)
        {
            try
            {
                using (var cnn = new NpgsqlConnection(connection))
